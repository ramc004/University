...
\begin{document}
    ...
    Firmware uses ESP-IDF with FreeRTOS. Multi-task architecture separates \ac{BLE}, Wi-Fi, \ac{LED} control, and \ac{AI} learning. \ac{BLE} follows \ac{GATT} with custom UUIDs for power, brightness, \ac{RGB}, mode selection, and status \href{run:/Users/calebram/Desktop/University/OneDrive - University of Surrey/Desktop/Year 3 Project/Reports/Mid-term Report/src/Project Code/AI-Based Smart Bulb for Adaptive Home Automation/AI-Based Smart Bulb for Adaptive Home Automation/BLEManager.swift}{[BLEManager.swift]}.
    ...
    \ac{BLE} integration via CoreBluetooth enables device discovery and connection management \href{run:/Users/calebram/Desktop/University/OneDrive - University of Surrey/Desktop/Year 3 Project/Reports/Mid-term Report/src/Project Code/AI-Based Smart Bulb for Adaptive Home Automation/AI-Based Smart Bulb for Adaptive Home Automation/BLEManager.swift}{[BLEManager.swift]}. Simulator mode allows testing without hardware. \ac{UI} supports power, brightness, \ac{RGB}, and effects (solid, fade, rainbow, pulse) with real-time state sync. Settings allow preference configuration, automation rules, and diagnostics.
    ...
    \begin{table}[h!]
        ...
        \begin{tabular}{l l}
            ...
            Peripherals & \ac{SPI}, I2C, I2S, \ac{UART}, \ac{ADC}, \ac{DAC}, \ac{PWM} \\
    ...
    \begin{table}[h!]
        \caption{Cable Matters Braided \ac{USB}-C to Micro \ac{USB} Cable Specifications}
        \centering
        \begin{tabular}{l l}
            \hline
            \textbf{Specification} & \textbf{Details} \\
            \hline
            Type & \ac{USB}-C to Micro \ac{USB} Cable \\
            Length & 0.3 m \\
            Max Current & 3 A \\
            Max Power & 15 W \\
            ...
            Color & Black \\
            Product & Cable Matters Braided \ac{USB}-C to Micro \ac{USB} Cord \\
            \hline
        \end{tabular}
    \end{table}
